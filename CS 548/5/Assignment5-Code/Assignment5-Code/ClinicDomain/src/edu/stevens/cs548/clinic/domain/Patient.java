...
public class Patient implements Serializable {
	...
	public void addDrugTreatment(String dName, String diagnosis, float dosage, Provider provider){
		...
		drugTreatment.setDiagnosis(diagnosis); //getting from treatment class
		drugTreatment.setDrug(dName); //getting from drugtreatment class
		drugTreatment.setDosage(dosage); //getting from drugtreatment class
		drugTreatment.setProvider(provider); //getting from treatment class
	...
	public void addRadiologyTreatment(List<Date> radiologyDates,String diagnosis,Provider provider){
		...
		radiology.setDiagnosis(diagnosis); //getting from treatment class
		radiology.setProvider(provider); //getting from treatment class
	...
	public void addSurgeryTreatment(Date surgeryDate, String diagnosis, Provider provider){
		...
		surgeryTreatment.setDate(surgeryDate); //getting from surgery class
		surgeryTreatment.setDiagnosis(diagnosis); //getting from treatment class
		surgeryTreatment.setProvider(provider); //getting from treatment class
